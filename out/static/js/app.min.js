...
angular.module("HeraldApp.config",[]).constant("ENV",{name:"production",debug:!0,version:"1.0.0",api:"//heraldstudio.com/herald/api/v1"}).config(["$ionicConfigProvider",function(o){o.tabs.position("bottom")}]);
