...
angular.module("HeraldApp").controller("yuyueBeforeCtrl",["$state","User","$rootScope","MessageShow",function(e,t,o,n){var r=t.getCurrentUser();r.token?o.user=r:(n.MessageShow("请先登录",1e3),o.lastState="yuyue.home",e.go("login"))}]).controller("yuyueCtrl",["$scope","callApi","$ionicLoading","User","MessageShow","$http","$state","yuyueService","$rootScope",function(e,t,o,n,r,a,u,s,d){function l(){!e.dateInfo&&g.token&&y()}var c={getDateUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/initOrderIndexP.do?sclId=1",method:"GET"},myOrderUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/fetchMyOrdersP.do?sclId=1",method:"GET"},getOrderInfoUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/phoneOrder/getOrderInfoP.do",method:"GET"},judgeOrderUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/judgeOrderP.do",method:"GET"},getPhoneUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/initEditOrderP.do?sclId=1",method:"GET"}},h={7:{name:"乒乓球"},8:{name:"篮球"},9:{name:"排球"},10:{name:"羽毛球"},11:{name:"舞蹈"},12:{name:"健身"},13:{name:"武术"},14:{name:"跆拳道"}};e.typeInfo=h;var m=function(e){var t={url:c[e].url,method:c[e].method};return t},g=n.getCurrentUser(),y=function(){var e=m("getDateUrl");t.getData("/yuyue","POST",e,g.token).then(function(e){200!=e.code?401==e.code?(d.lastState="yuyue.home",u.go("login")):r.MessageShow(e.content,2e3):f(e.content)},function(e){r.MessageShow("网络错误",2e3)})},f=function(t){var o={today:{dayInfo:t.timeList[0].dayInfo.split(" ")[0],weekInfo:t.timeList[0].dayInfo.split(" ")[1]},tomorrow:{dayInfo:t.timeList[1].dayInfo.split(" ")[0],weekInfo:t.timeList[1].dayInfo.split(" ")[1]},afterTomo:{dayInfo:t.timeList[2].dayInfo.split(" ")[0],weekInfo:t.timeList[2].dayInfo.split(" ")[1]}};e.dateInfo=o},p=!0,S=function(o,n){!U[n][o]&&p&&(p=!1,r.MessageShow("正在加载",1e4),data=m("getOrderInfoUrl"),data.data={sclId:1,itemId:o,dayInfo:e.dateInfo[n].dayInfo},t.getData("/yuyue","POST",data,g.token).then(function(e){200!=e.code?401==e.code?(d.lastState="yuyue.home",u.go("login")):r.MessageShow(e.content,2e3):I(o,n,e.content)},function(e){r.MessageShow("网络错误",2e3)}))},U={today:{},tomorrow:{},afterTomo:{}};e.orderInfo=U;var I=function(e,t,o){U[t][e]||(U[t][e]=[]);for(i in o.orderIndexs){var n={used:o.orderIndexs[i].usedSite,all:o.orderIndexs[i].allSite,avaliTime:o.orderIndexs[i].avaliableTime,enable:o.orderIndexs[i].enable};U[t][e].push(n)}r.hide(),p=!0},w={today:{},tomorrow:{},afterTomo:{}};e.toggleGroup=function(e,t){w[e][t]=w[e][t]|!1,w[e][t]=!w[e][t],w[e][t]&&S(t,e)},e.isToggleGroup=function(e,t){return w[e][t]},e.newOrder=function(t,o,n){var r=e.dateInfo[o].dayInfo;M(t,r,n)};var M=function(e,o,n){var a=m("judgeOrderUrl");a.data={sclId:1,itemId:e,dayInfo:o,time:n},t.getData("/yuyue","POST",a,g.token).then(function(t){200!=t.code?401==a.code?(d.lastState="yuyue.home",u.go("login")):r.MessageShow(a.content,2e3):(console.log("judge result start"),console.log(t.content),console.log("judge result end"),0!=t.content.code?r.MessageShow(t.content.msg,2e3):(s.setInfo(h[e].name,e,n,o,t.content),O()))},function(e){r.MessageShow("网络错误",2e3)})},O=function(){var e=m("getPhoneUrl");t.getData("/yuyue","POST",e,g.token).then(function(e){200!=e.code?r.MessageShow(e.content,2e3):(s.setPhone(e.content.phone),u.go("yuyue-new"))},function(){r.MessageShow("网络错误",2e3)})};l()}]).controller("yuyueNewCtrl",["$scope","yuyueService","callApi","MessageShow","User","$ionicModal","$sce",function(e,t,o,n,r,a,u){function s(){U(),1==l.data.item.allowHalf?(i.allGround=[{id:1,name:"全场"},{id:2,name:"半场"}],i.max={1:l.data.item.fullMaxUsers,2:l.data.item.halfMaxUsers},i.min={1:l.data.item.fullMinUsers,2:l.data.item.halfMinUsers}):(i.allGround=[{id:2,name:"半场"}],i.max={2:l.data.item.fullMaxUsers},i.min={2:l.data.item.fullMinUsers}),i.MySelect=i.allGround[0].id,a.fromTemplateUrl("addFriend.html",{scope:e,animation:"slide-in-up"}).then(function(t){e.modal=t})}var d,l=t.getInfo(),c={myOrderUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/fetchMyOrdersP.do?sclId=1",method:"GET"},validateImgUrl:{url:"http://yuyue.seu.edu.cn/eduplus/control/validateimage",method:"GET"},getFriendList:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/searchUserP.do?sclId=1&pageNumber=1&start=0&pageSize=5",method:"GET"},newUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/insertOredrP.do",method:"GET"}},i={allUserNum:0,allUser:[],allUserString:"",searchUser:[],searchCardnum:""};e.yuyueInfo=l,e.groundInfo=i;var h=function(e){i.allUser.pop(e)};e.removeUser=h;var m=function(e){i.allUser.push(e),e.state=!1};e.newUser=m;var g=function(){var e=i.searchCardnum,t={url:c.getFriendList.url+"&cardNo="+e,method:c.getFriendList.method};o.getData("/yuyue","POST",t,d.token).then(function(o){200!=o.code?401==t.code?($rootScope.lastState="yuyue.home",$state.go("login")):n.MessageShow(t.content,2e3):y(e,o.content)},function(){n.MessageShow("网络错误",2e3)})},y=function(e,t){if(i.searchUser=[],t.total<1)n.MessageShow("没有搜索到该用户",1e3);else for(var o=0;o<t.rows.length;o++){var r={cardnum:e,name:t.rows[o].nameDepartment,userId:t.rows[o].userId,state:!0};i.searchUser.push(r)}};e.searchUser=g;var f=function(){i.allUserNum=i.allUser.length,i.allUserString="";for(var t=0;t<i.allUser.length;t++)i.allUserString+=i.allUser[t].name+"</br>";i.allUserString=u.trustAsHtml(i.allUserString),e.modal.hide()};e.completeAddUser=f;var p=function(){l.phone&&11==l.phone.length?i.allUserNum+1<i.min[i.MySelect]||i.allUserNum+1>i.max[i.MySelect]?n.MessageShow("人数不合法",1e3):S():n.MessageShow("手机号不合法",1e3)};e.judegInfo=p;var S=function(){var t={"orderVO.useMode":e.groundInfo.MySelect,sclId:1,"orderVO.useTime":l.day+" "+l.time,"orderVO.itemId":l.id,"orderVO.phone":l.phone,"orderVO.remark":""},r=c.newUrl.url+"?",a=0;for(var u in t)0==a?(r+=u+"="+t[u],a=1):r+="&"+u+"="+encodeURIComponent(t[u]);for(var u=0;u<i.allUserNum;u++)r+="&useUserIds="+i.allUser[u].userId;var s={url:r,method:c.newUrl.method};o.getData("/yuyue","POST",s,d.token).then(function(e){200==e.code?401==s.code?($rootScope.lastState="yuyue.home",$state.go("login")):n.MessageShow(s.content,2e3):n.MessageShow(e.content,2e3)},function(){n.MessageShow("网络错误",2e3)})},U=function(){d=r.getCurrentUser(),d.token||(n.MessageShow("请先登录",1e3),$rootScope.lastState="yuyue-new",$state.go("login"))};s()}]).controller("yuyueMyCtrl",["$scope","callApi","Storage","User","MessageShow",function(e,t,o,n,r){function a(){var e={url:d.myOrderUrl.url,method:d.myOrderUrl.method};t.getData("/yuyue","POST",e,l.token).then(function(e){200!=e.code?401==e.code?($rootScope.lastState="yuyue.home",$state.go("login")):r.MessageShow(e.content,2e3):u(e)},function(e){r.MessageShow("网络错误",2e3)})}function u(t){e.Myorder=t}function s(){e.Myorder||a()}var d={myOrderUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/fetchMyOrdersP.do?sclId=1",method:"GET"},cancelUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/delOrderP.do?sclId=1",method:"GET"}},l=n.getCurrentUser(),c=function(e){var o={url:d.cancelUrl.url+"&id="+e,method:d.cancelUrl.method};console.log("cancel id:"+e),t.getData("/yuyue","POST",o,l.token).then(function(e){200!=e.code?r.MessageShow(e.content,2e3):"success"==e.content.msg?(r.MessageShow("取消成功",2e3),a()):r.MessageShow(e.content.msg,2e3)},function(){r.MessageShow("网络错误",2e3)})};e.cancelOrder=c,e.stateContent={4:"通过",6:"取消",2:"完成"},s()}]);