angular.module("HeraldApp",["ionic","HeraldApp.config","HeraldApp.services"]).config(["$stateProvider","$urlRouterProvider","$ionicConfigProvider",function(e,t,l){e.state("index",{url:"/herald","abstract":!0,templateUrl:"pages/index/menu.html"}).state("index.home",{url:"/home",views:{home:{templateUrl:"pages/index/home.html",controller:"HomeCtrl"}}}).state("index.state2",{url:"/state2",views:{home:{templateUrl:"pages/index/state2.html",controller:"MyCtrl"}}}).state("login",{url:"/login",templateUrl:"pages/auth/login.html",controller:"LoginCtrl"}).state("register",{url:"/register",templateUrl:"pages/auth/register.html",controller:"registerCtrl"}).state("activity",{url:"/activity",templateUrl:"pages/activity/activity.html",controller:"activityCtrl"}).state("deliver",{url:"/deliver","abstract":!0,templateUrl:"pages/deliver/menu.html",controller:"DeliverCtrl"}).state("deliver.home",{url:"/home",views:{deliver:{templateUrl:"pages/deliver/home.html",controller:"DeliverCtrl"}}}).state("deliver.new",{url:"/new",views:{deliver:{templateUrl:"pages/deliver/post.html",controller:"DeliverPostCtrl"}}}).state("deliver.admin_login",{url:"/admin_login",views:{deliver:{templateUrl:"pages/deliver/admin_login.html",controller:"DeliverAdminLoginCtrl"}}}).state("deliver.admin",{url:"/admin",views:{deliver:{templateUrl:"pages/deliver/admin.html",controller:"DeliverAdminCtrl"}}}).state("yuyue",{url:"/yuyue",cache:!1,"abstract":!0,templateUrl:"pages/yuyue/menu.html",controller:"yuyueBeforeCtrl"}).state("yuyue.home",{url:"/home",views:{"yuyue-home":{templateUrl:"pages/yuyue/home.html",controller:"yuyueCtrl"}}}).state("yuyue-new",{url:"/yuyue/new",cache:!1,templateUrl:"pages/yuyue/new.html",controller:"yuyueNewCtrl"}).state("yuyue.My",{url:"/my",views:{"yuyue-my":{templateUrl:"pages/yuyue/my.html",controller:"yuyueMyCtrl"}}}),t.otherwise("/herald/home")}]).controller("MyCtrl",["$scope","$state",function(e,t){}]);
angular.module("HeraldApp.config",[]).constant("ENV",{name:"production",debug:!0,version:"1.0.0",api:"http://127.0.0.1:7000/herald/api/v1"}).config(["$ionicConfigProvider",function(o){o.tabs.position("bottom")}]);
...
angular.module("HeraldApp.services",[]).service("Storage",["ENV",function(e){this.set=function(e,t){return window.localStorage.setItem(e,window.JSON.stringify(t))},this.get=function(e){return window.JSON.parse(window.localStorage.getItem(e))},this.remove=function(e){return window.localStorage.removeItem(e)}}]).service("User",["Storage","callApi","$q","$log",function(e,t,n,r){var o="user",i=e.get(o)||{};r.debug("service start"),this.login=function(r,s){return data={user_phone:r,password:s},loginDefer=n.defer(),t.getData("/auth/login","POST",data).then(function(t){200==t.code?(i.token=t.content,e.set(o,i),loginDefer.resolve(null)):loginDefer.resolve(t.content)},function(e){loginDefer.reject(e)}),loginDefer.promise},this.register=function(r,s,a,c){return data={phone:r,password:s,cardnumber:a,card_password:c},registerDefer=n.defer(),t.getData("/auth/reg","POST",data).then(function(t){200==t.code?(i.token=t.content,e.set(o,i),registerDefer.resolve(null)):registerDefer.resolve(t.content)},function(e){registerDefer.reject(e)}),registerDefer.promise},this.logout=function(){e.remove(o)};this.getCurrentUser=function(){return i},this.checkUser=function(){}}]).service("DeliverAdmin",["Storage","callApi","$q",function(e,t,n){var r="deliverAdmin",o=e.get(r)||{};this.login=function(i,s){return data={admin_name:i,password:s},loginDefer=n.defer(),t.getData("/deliver/admin_login","POST",data).then(function(t){200==t.code?(o.token=t.content,e.set(r,o),loginDefer.resolve(null)):loginDefer.resolve(t.content)},function(e){loginDefer.reject(e)}),loginDefer.promise};this.getCurrentUser=function(){return o},this.checkUser=function(){}}]).service("MessageShow",["$ionicLoading",function(e){this.errorShow=function(t){e.show({template:t,noBackdrop:!0,duration:2e3})},this.MessageShow=function(t,n){var n=2e3|n;e.show({template:t,noBackdrop:!0,duration:n})},this.show=function(t){e.show({template:t,noBackdrop:!0})},this.hide=function(){e.hide()}}]).service("yuyueService",["$http",function(e){var t={name:"健身",id:"12",time:"19:00-20:00",day:"2015-12-18",phone:"",data:{code:0,item:{allowHalf:0,fullMaxUsers:1,fullMinUsers:1,halfMaxUsers:1,halfMinUsers:1}}};this.getInfo=function(){return t},this.setInfo=function(e,n,r,o,i){t.name=e,t.id=n,t.time=r,t.day=o,t.data=i},this.setPhone=function(e){t.phone=e}}]).service("callApi",["$http","ENV","$q","$log",function(e,t,n,r){var o=1;this.namedata=function(){return o},this.getData=function(r,o,i,s,a){var c=n.defer(),u=t.api+r;i=i||null,a=a||null;var l={method:o,url:u,headers:{token:s},timeout:1e4};return"GET"==o?l.params=i:"POST"==o&&(a||(l.transformRequest=function(e){var t=[];for(var n in e)"data"!=n?t.push(encodeURIComponent(n)+"="+encodeURIComponent(e[n])):t.push(encodeURIComponent(n)+"="+JSON.stringify(e[n]));return t.join("&")}),l.headers["Content-Type"]="application/x-www-form-urlencoded",l.data=i),e(l).success(function(e){c.resolve(e)}).error(function(e,t,n){c.reject(e)}),c.promise}}]);
...
angular.module("HeraldApp").controller("DeliverAdminLoginCtrl",["$scope","MessageShow","$state","$rootScope","DeliverAdmin",function(e,o,n,r,a){e.formData={login_username:"",login_password:""};var i="deliver.admin",l=function(e){return e.login_username.length<1?"用户名不能为空!":e.login_password.length<1?"密码不能为空":null};e.login=function(r){var t=l(e.formData);t?e.error_message=t:a.login(e.formData.login_username,e.formData.login_password).then(function(r){r?e.error_message=r:(o.MessageShow("登录成功",1e3),n.transitionTo(i,{},{reload:!0,notify:!0}))},function(e){o.MessageShow("网络错误",1e3)})}}]).controller("DeliverAdminCtrl",["$scope","callApi","DeliverAdmin","MessageShow","$rootScope","$state",function(e,o,n,r,a,i){function l(){t.token||(r.MessageShow("请先登录",1e3),i.go("deliver.admin_login"))}var t=n.getCurrentUser();l()}]);
angular.module("HeraldApp").controller("DeliverCtrl",["$scope","callApi","MessageShow","$ionicLoading","User","$state","$rootScope",function(e,o,t,n,a,r,c){function i(e,o){return e||o?e&&!o?"派送中":e&&o?"已完成":"未知":"未接单"}function s(){e.show(),d(1,function(){e.hide()})}var l={page:1,scrollState:!0,content:[]};e.order=l;var h=a.getCurrentUser(),d=function(n,a){var s={page:n};o.getData("/deliver/query","POST",s,h.token).then(function(o){if(200!=o.code)302==o.code?(c.lastState="deliver.home",r.go("login")):t.MessageShow(o.content,2e3);else{var n=o.content;n.forEach(function(e){e.state=i(e.receiving,e.finish),"未接单"===e.state&&(e.cancel=!0)}),e.order.content=e.order.content.concat(n),n.length<10&&(e.order.scrollState=!1)}"function"==typeof a&&a(o.code)})["catch"](function(e){t.MessageShow("网络错误",2e3),"function"==typeof a&&a()})};e.doRefresh=function(){e.order.page=1,e.order.content=[],e.order.scrollState=!0,d(1,function(o){e.$broadcast("scroll.refreshComplete"),200==o&&t.MessageShow("刷新成功",2e3)})},e.addItems=function(){l.page+=1,d(l.page,function(){e.$broadcast("scroll.refreshComplete")})},e.show=function(){n.show({template:"正在加载..."})},e.hide=function(){n.hide()},e.cancel=function(n){var a={id:n};o.getData("/deliver/delete","POST",a,h.token).then(function(o){if(200!=o.code)302==o.code?(c.lastState="deliver.home",r.go("login")):t.MessageShow(o.content,2e3);else{t.MessageShow("取消成功",2e3);var a=e.order.content;a.forEach(function(e,o){return e.id===n?void a.splice(o,1):void 0})}})["catch"](function(e){t.MessageShow("网络错误",2e3)})},s()}]).controller("DeliverPostCtrl",["$scope","callApi","MessageShow","$ionicLoading","User","$state","$rootScope",function(e,o,t,n,a,r,c){var i=a.getCurrentUser();e.info={name:"",sms:"",phone:"",location:0,arrival:0,weight:0,dest:0};var s={location:["东门","南门"],arrival:["12:20~12:40","17:40~18:00"],weight:["2kg以下","2~4kg","4kg以上"],dest:["梅九大厅","梅三四大厅"]};e.show_info=s,e.select=function(o,t){e.info[o]=t},e.submit=function(){var n=e.info;if(n.name.length<1||n.sms.length<1||n.phone.length<1)alert("信息不能为空");else{var a={user_name:n.name,dest:s.dest[n.dest],sms_txt:n.sms,arrival:s.arrival[n.arrival],locate:s.location[n.location],weight:s.weight[n.weight],phone:n.phone};o.getData("/deliver/submit","POST",a,i.token).then(function(e){200!=e.code?302==e.code?(c.lastState="deliver.home",r.go("login")):t.MessageShow(e.content,2e3):(t.MessageShow("提交成功",2e3),r.go("deliver.home"))})["catch"](function(e){t.MessageShow("网络错误",2e3)})}}}]);
