...
angular.module("HeraldApp").controller("DeliverCtrl",["$scope","callApi","MessageShow","$ionicLoading","User","$state","$rootScope",function(e,o,t,n,r,c,a){function l(){e.show(),d(1,function(){e.hide()})}var s={page:1,scrollState:!0,content:[]};e.order=s;var i=r.getCurrentUser(),d=function(n,r){var l={page:n};o.getData("/deliver/query","POST",l,i.token).then(function(o){if(200!=o.code)302==o.code?(a.lastState="deliver.home",c.go("login")):t.MessageShow(o.content,2e3);else{var n=o.content;e.order.content=e.order.content.concat(n),n.length<10&&(e.order.scrollState=!1)}"function"==typeof r&&r(o.code)})["catch"](function(e){t.MessageShow("网络错误",2e3),"function"==typeof r&&r()})};e.doRefresh=function(){e.order.page=1,e.order.content=[],e.order.scrollState=!0,d(1,function(o){e.$broadcast("scroll.refreshComplete"),200==o&&t.MessageShow("刷新成功",2e3)})},e.addItems=function(){s.page+=1,d(s.page,function(){e.$broadcast("scroll.refreshComplete")})},e.show=function(){n.show({template:"正在加载..."})},e.hide=function(){n.hide()},l()}]);
