...
angular.module("HeraldApp").controller("yuyueBeforeCtrl",["$state","User","$rootScope","MessageShow",function(e,t,n,o){var r=t.getCurrentUser();r.token?n.user=r:(o.MessageShow("请先登录",1e3),n.lastState="yuyue.home",e.go("login"))}]).controller("yuyueCtrl",["$scope","callApi","$ionicLoading","User","MessageShow","$http","$state","yuyueService","$rootScope",function(e,t,n,o,r,a,s,u,d){function l(){!e.dateInfo&&f.token&&g()}var c={getDateUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/initOrderIndexP.do?sclId=1",method:"GET"},myOrderUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/fetchMyOrdersP.do?sclId=1",method:"GET"},getOrderInfoUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/phoneOrder/getOrderInfoP.do",method:"GET"},judgeOrderUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/judgeOrderP.do",method:"GET"},getPhoneUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/initEditOrderP.do?sclId=1",method:"GET"}},h={7:{name:"乒乓球"},8:{name:"篮球"},9:{name:"排球"},10:{name:"羽毛球"},11:{name:"舞蹈"},12:{name:"健身"},13:{name:"武术"},14:{name:"跆拳道"}};e.typeInfo=h;var m=function(e){var t={url:c[e].url,method:c[e].method};return t},f=o.getCurrentUser(),g=function(){var e=m("getDateUrl");t.getData("/yuyue","POST",e,f.token).then(function(e){200!=e.code?r.MessageShow(e.content,2e3):y(e.content)},function(e){r.MessageShow("网络错误",2e3)})},y=function(t){var n={today:{dayInfo:t.timeList[0].dayInfo.split(" ")[0],weekInfo:t.timeList[0].dayInfo.split(" ")[1]},tomorrow:{dayInfo:t.timeList[1].dayInfo.split(" ")[0],weekInfo:t.timeList[1].dayInfo.split(" ")[1]},afterTomo:{dayInfo:t.timeList[2].dayInfo.split(" ")[0],weekInfo:t.timeList[2].dayInfo.split(" ")[1]}};e.dateInfo=n},p=!0,U=function(n,o){!S[o][n]&&p&&(p=!1,r.MessageShow("正在加载",1e4),data=m("getOrderInfoUrl"),data.data={sclId:1,itemId:n,dayInfo:e.dateInfo[o].dayInfo},t.getData("/yuyue","POST",data,f.token).then(function(e){200!=e.code?r.MessageShow(e.content,2e3):I(n,o,e.content)},function(e){r.MessageShow("网络错误",2e3)}))},S={today:{},tomorrow:{},afterTomo:{}};e.orderInfo=S;var I=function(e,t,n){S[t][e]||(S[t][e]=[]);for(i in n.orderIndexs){var o={used:n.orderIndexs[i].usedSite,all:n.orderIndexs[i].allSite,avaliTime:n.orderIndexs[i].avaliableTime,enable:n.orderIndexs[i].enable};S[t][e].push(o)}r.hide(),p=!0},w={today:{},tomorrow:{},afterTomo:{}};e.toggleGroup=function(e,t){w[e][t]=w[e][t]|!1,w[e][t]=!w[e][t],w[e][t]&&U(t,e)},e.isToggleGroup=function(e,t){return w[e][t]},e.newOrder=function(t,n,o){var r=e.dateInfo[n].dayInfo;M(t,r,o)};var M=function(e,n,o){var a=m("judgeOrderUrl");a.data={sclId:1,itemId:e,dayInfo:n,time:o},t.getData("/yuyue","POST",a,f.token).then(function(t){200!=t.code?r.MessageShow(a.content,2e3):(console.log("judge result start"),console.log(t.content),console.log("judge result end"),0!=t.content.code?r.MessageShow(t.content.msg,2e3):(u.setInfo(h[e].name,e,o,n,t.content),O()))},function(e){r.MessageShow("网络错误",2e3)})},O=function(){var e=m("getPhoneUrl");t.getData("/yuyue","POST",e,f.token).then(function(e){200!=e.code?r.MessageShow(e.content,2e3):(u.setPhone(e.content.phone),s.go("yuyue-new"))},function(){r.MessageShow("网络错误",2e3)})};l()}]).controller("yuyueNewCtrl",["$scope","yuyueService","callApi","MessageShow","User","$ionicModal","$sce",function(e,t,n,o,r,a,s){function u(){S(),1==l.data.item.allowHalf?(i.allGround=[{id:1,name:"全场"},{id:2,name:"半场"}],i.max={1:l.data.item.fullMaxUsers,2:l.data.item.halfMaxUsers},i.min={1:l.data.item.fullMinUsers,2:l.data.item.halfMinUsers}):(i.allGround=[{id:2,name:"半场"}],i.max={2:l.data.item.fullMaxUsers},i.min={2:l.data.item.fullMinUsers}),i.MySelect=i.allGround[0].id,a.fromTemplateUrl("addFriend.html",{scope:e,animation:"slide-in-up"}).then(function(t){e.modal=t})}var d,l=t.getInfo(),c={myOrderUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/fetchMyOrdersP.do?sclId=1",method:"GET"},validateImgUrl:{url:"http://yuyue.seu.edu.cn/eduplus/control/validateimage",method:"GET"},getFriendList:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/searchUserP.do?sclId=1&pageNumber=1&start=0&pageSize=5",method:"GET"},newUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/insertOredrP.do",method:"GET"}},i={allUserNum:0,allUser:[],allUserString:"",searchUser:[],searchCardnum:""};e.yuyueInfo=l,e.groundInfo=i;var h=function(e){i.allUser.pop(e)};e.removeUser=h;var m=function(e){i.allUser.push(e),e.state=!1};e.newUser=m;var f=function(){var e=i.searchCardnum,t={url:c.getFriendList.url+"&cardNo="+e,method:c.getFriendList.method};n.getData("/yuyue","POST",t,d.token).then(function(t){200!=t.code?o.MessageShow(t.content,2e3):g(e,t.content)},function(){o.MessageShow("网络错误",2e3)})},g=function(e,t){if(i.searchUser=[],t.total<1)o.MessageShow("没有搜索到该用户",1e3);else for(var n=0;n<t.rows.length;n++){var r={cardnum:e,name:t.rows[n].nameDepartment,userId:t.rows[n].userId,state:!0};i.searchUser.push(r)}};e.searchUser=f;var y=function(){i.allUserNum=i.allUser.length,i.allUserString="";for(var t=0;t<i.allUser.length;t++)i.allUserString+=i.allUser[t].name+"</br>";i.allUserString=s.trustAsHtml(i.allUserString),e.modal.hide()};e.completeAddUser=y;var p=function(){l.phone&&11==l.phone.length?i.allUserNum+1<i.min[i.MySelect]||i.allUserNum+1>i.max[i.MySelect]?o.MessageShow("人数不合法",1e3):U():o.MessageShow("手机号不合法",1e3)};e.judegInfo=p;var U=function(){var t={"orderVO.useMode":e.groundInfo.MySelect,sclId:1,"orderVO.useTime":l.day+" "+l.time,"orderVO.itemId":l.id,"orderVO.phone":l.phone,"orderVO.remark":""},r=c.newUrl.url+"?",a=0;for(var s in t)0==a?(r+=s+"="+t[s],a=1):r+="&"+s+"="+encodeURIComponent(t[s]);for(var s=0;s<i.allUserNum;s++)r+="&useUserIds="+i.allUser[s].userId;var u={url:r,method:c.newUrl.method};n.getData("/yuyue","POST",u,d.token).then(function(e){200==e.code?o.MessageShow(e.content.msg,2e3):o.MessageShow(e.content,2e3)},function(){o.MessageShow("网络错误",2e3)})},S=function(){d=r.getCurrentUser(),d.token||(o.MessageShow("请先登录",1e3),$rootScope.lastState="yuyue-new",$state.go("login"))};u()}]).controller("yuyueMyCtrl",["$scope","callApi","Storage","User","MessageShow",function(e,t,n,o,r){function a(){var e={url:d.myOrderUrl.url,method:d.myOrderUrl.method};t.getData("/yuyue","POST",e,l.token).then(function(e){200!=e.code?r.MessageShow(e.content,2e3):s(e)},function(e){r.MessageShow("网络错误",2e3)})}function s(t){e.Myorder=t}function u(){e.Myorder||a()}var d={myOrderUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/fetchMyOrdersP.do?sclId=1",method:"GET"},cancelUrl:{url:"http://yuyue.seu.edu.cn/eduplus/phoneOrder/delOrderP.do?sclId=1",method:"GET"}},l=o.getCurrentUser(),c=function(e){var n={url:d.cancelUrl.url+"&id="+e,method:d.cancelUrl.method};console.log("cancel id:"+e),t.getData("/yuyue","POST",n,l.token).then(function(e){200!=e.code?r.MessageShow(e.content,2e3):"success"==e.content.msg?(r.MessageShow("取消成功",2e3),a()):r.MessageShow(e.content.msg,2e3)},function(){r.MessageShow("网络错误",2e3)})};e.cancelOrder=c,e.stateContent={4:"通过",6:"取消",2:"完成"},u()}]);