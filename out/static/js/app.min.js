...
angular.module("HeraldApp").controller("DeliverCtrl",["$scope","callApi","MessageShow","$ionicLoading","User","$state","$rootScope",function(e,o,t,n,r,c,a){function i(e,o){return e||o?e&&!o?"派送中":e&&o?"已完成":"未知":"未接单"}function s(){e.show(),d(1,function(){e.hide()})}var l={page:1,scrollState:!0,content:[]};e.order=l;var f=r.getCurrentUser(),d=function(n,r){var s={page:n};o.getData("/deliver/query","POST",s,f.token).then(function(o){if(200!=o.code)302==o.code?(a.lastState="deliver.home",c.go("login")):t.MessageShow(o.content,2e3);else{var n=o.content;n.forEach(function(e){e.state=i(e.receiving,e.finish),"未接单"===e.state&&(e.cancel=!0)}),e.order.content=e.order.content.concat(n),n.length<10&&(e.order.scrollState=!1)}"function"==typeof r&&r(o.code)})["catch"](function(e){t.MessageShow("网络错误",2e3),"function"==typeof r&&r()})};e.doRefresh=function(){e.order.page=1,e.order.content=[],e.order.scrollState=!0,d(1,function(o){e.$broadcast("scroll.refreshComplete"),200==o&&t.MessageShow("刷新成功",2e3)})},e.addItems=function(){l.page+=1,d(l.page,function(){e.$broadcast("scroll.refreshComplete")})},e.show=function(){n.show({template:"正在加载..."})},e.hide=function(){n.hide()},s()}]);
